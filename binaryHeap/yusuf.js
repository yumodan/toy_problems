...
BinaryHeap.prototype.insert = function (value) {
  ...
  this.bubble(this.parent(this._heap.length - 1));
}
BinaryHeap.prototype.removeRoot = function () {
  swap(this._heap.length - 1, 0, this._heap);
  let temp = this._heap.pop()
  this.bubble(0, false); //this will actually bubble down bc of the second param
  return temp;
}
...
BinaryHeap.prototype.bubble = function(index, up){ //up must be false (bool) to bubble down
  ...
  //if it is greater than its child nodes
    ...
    //if you want to bubble down call the bubble function recursively on the index of the smaller child node
    //if you want to bubble up call the bubble  function recursively on the parent node
